...
/*
How are for loops constructed in C++: for (int i = 0; i < 10; i++) {
    cout << i << endl;
}
When do you need to use curly brackets in C++: multi-statement code, declaring compound statement
How do you compare items in arrays: line 45
How do you use an array as an argument in a function: line
What is type_t:48
Why would we use type_t: make the type safe,
How do you search an array: use find
How do you sort an array:use sort
How do you make a multi-dimensional array:  line 45
*/
